...
The script can be executed multiple times to append new listings to the database without fear of duplicate rows or repeated index values. To use the script, one must replace the sqlalchemy argument ('postgresql://user:password@localhost/mydatabase') to an existing postgresql database.
