...
def create_or_append(df):
    ...
    engine = sqlalchemy.create_engine('postgresql://christopher:SimmNorm2023!@localhost:5433/craigslist_listings')
    ...
    if inspector.has_table("mytable"):
        ...
        new_indexes = [i for i in range (new_index, new_index + 120)]
